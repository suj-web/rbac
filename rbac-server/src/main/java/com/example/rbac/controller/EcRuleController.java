...
public class EcRuleController {
    ...
    @OperationLogAnnotation(operModul = "奖惩规则",operType = "查询",operDesc = "查询所有奖惩规则")
    ...
    @OperationLogAnnotation(operModul = "奖惩规则",operType = "添加",operDesc = "添加所有奖惩规则")
    ...
    @OperationLogAnnotation(operModul = "奖惩规则",operType = "修改",operDesc = "修改所有奖惩规则")
